...
class UABP_FireKirin_Implementation_C : public UAnimInstance
{
    ...
    FAnimNode_LookAt AnimGraphNode_LookAt_3;                                          // 0x11C0 (size: 0x250)
    ...
    FAnimNode_LookAt AnimGraphNode_LookAt_2;                                          // 0x1450 (size: 0x250)
    FAnimNode_LookAt AnimGraphNode_LookAt_1;                                          // 0x16A0 (size: 0x250)
    FAnimNode_LookAt AnimGraphNode_LookAt;                                            // 0x18F0 (size: 0x250)
    FAnimNode_Root AnimGraphNode_Root;                                                // 0x1B40 (size: 0x20)
    double __CustomProperty_PositionAlpha_leg_back_04_r_Goal_1EE441004E048D80699AC69BB5791A9C; // 0x1B60 (size: 0x8)
    double __CustomProperty_PositionAlpha_leg_back_04_l_Goal_1EE441004E048D80699AC69BB5791A9C; // 0x1B68 (size: 0x8)
    double __CustomProperty_PositionAlpha_leg_front_04_r_Goal_1EE441004E048D80699AC69BB5791A9C; // 0x1B70 (size: 0x8)
    double __CustomProperty_PositionAlpha_leg_front_04_l_Goal_1EE441004E048D80699AC69BB5791A9C; // 0x1B78 (size: 0x8)
    FVector LookAtWorldLocation;                                                      // 0x1B80 (size: 0x18)
