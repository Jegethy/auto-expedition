#ifndef UE4SS_SDK_BP_SkillEffect_PoisonShower_Bullet_HPP
#define UE4SS_SDK_BP_SkillEffect_PoisonShower_Bullet_HPP

class ABP_SkillEffect_PoisonShower_Bullet_C : public ABP_SkillEffectBase_C
{
    ...
    void SpawnSign();
    void ExecuteUbergraph_BP_SkillEffect_PoisonShower_Bullet(int32 EntryPoint);
}; // Size: 0x478
