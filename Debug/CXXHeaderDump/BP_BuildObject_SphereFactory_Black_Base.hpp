...
{
    class UBP_WorkVisualFX_C* BP_WorkVisualFX4;                                       // 0x0750 (size: 0x8)
    class UPalWorkFacingComponent* WorkFacing4;                                       // 0x0758 (size: 0x8)
    class UStaticMeshComponent* SM_PalSphereFactoryMedieval;                          // 0x0760 (size: 0x8)
    class USceneComponent* StaticMesh;                                                // 0x0768 (size: 0x8)
