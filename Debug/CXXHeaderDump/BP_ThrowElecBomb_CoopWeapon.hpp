...
class ABP_ThrowElecBomb_CoopWeapon_C : public ABP_ThrowWeaponBase_C
{
    ...
    class USkeletalMeshComponent* SkeletalMesh;                                       // 0x06B0 (size: 0x8)
    bool Threw;                                                                       // 0x06B8 (size: 0x1)
    int32 WeaponDmageByOutside;                                                       // 0x06BC (size: 0x4)
    class AActor* Attacker;                                                           // 0x06C0 (size: 0x8)
