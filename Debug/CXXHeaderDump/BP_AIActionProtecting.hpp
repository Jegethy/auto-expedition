...
class UBP_AIActionProtecting_C : public UPalAIActionBase
{
    ...
    class APalCharacter* ProtectCharacter;                                            // 0x0140 (size: 0x8)
    FName RidingSpeedUpFlagName;                                                      // 0x0148 (size: 0x8)
    class APalCharacter* OwnerPawn;                                                   // 0x0150 (size: 0x8)
    class UPalPartnerSkillParameterComponent* PartnerSkillParam;                      // 0x0158 (size: 0x8)
    bool IsAborted;                                                                   // 0x0160 (size: 0x1)
    bool IsGliding;                                                                   // 0x0161 (size: 0x1)
    bool IsReleased;                                                                  // 0x0162 (size: 0x1)
