...
class UBP_AIAction_ThrowWeaponUsing_C : public UPalAIActionBase
{
    ...
    class APalCharacter* WeaponUser;                                                  // 0x0148 (size: 0x8)
    bool ShootAble;                                                                   // 0x0150 (size: 0x1)
    double Yaw;                                                                       // 0x0158 (size: 0x8)
    class UPalPartnerSkillParameterComponent* PartnerSkillParameter;                  // 0x0160 (size: 0x8)
    FName Flag Name;                                                                  // 0x0168 (size: 0x8)
    class UPalShooterComponent* Shooter;                                              // 0x0170 (size: 0x8)
    class UBP_CoopParam_Weapon_C* Coop;                                               // 0x0178 (size: 0x8)
    class AActor* ThrownBullet;                                                       // 0x0180 (size: 0x8)
