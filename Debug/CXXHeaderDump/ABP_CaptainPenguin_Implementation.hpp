...
class UABP_CaptainPenguin_Implementation_C : public UPalAnimInstance
{
    ...
    FAnimNode_LookAt AnimGraphNode_LookAt_3;                                          // 0x0D50 (size: 0x250)
    ...
    FAnimNode_LookAt AnimGraphNode_LookAt_2;                                          // 0x0FE0 (size: 0x250)
    FAnimNode_LookAt AnimGraphNode_LookAt_1;                                          // 0x1230 (size: 0x250)
    FAnimNode_LookAt AnimGraphNode_LookAt;                                            // 0x1480 (size: 0x250)
    FAnimNode_Root AnimGraphNode_Root_1;                                              // 0x16D0 (size: 0x20)
    FAnimNode_LinkedInputPose AnimGraphNode_LinkedInputPose_1;                        // 0x16F0 (size: 0xC8)
    FAnimNode_LinkedInputPose AnimGraphNode_LinkedInputPose;                          // 0x17B8 (size: 0xC8)
    FAnimNode_Root AnimGraphNode_Root;                                                // 0x1880 (size: 0x20)
    FVector LookAtWorldLocation;                                                      // 0x18A0 (size: 0x18)
